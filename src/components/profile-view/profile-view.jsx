...
export class ProfileView extends React.Component {
    ...
    getUser(token) {
        ...
        axios.get(`https://myflixs.herokuapp.com/users/${Username}`, {
    ...
    editUser = (e) => {
        ...
        axios.put(`https://myflixs.herokuapp.com/users/${Username}`,
            {
    ...
    onRemoveFavorite = (e, movies) => {
        ...
        axios.delete(`https://myflixs.herokuapp.com/users/${Username}/movies/${movie._id}`,
            {
                headers: { Authorization: `Bearer ${token}` }
            }
        )
    ...
    onDeleteUser() {
        ...
        axios.delete(`https://myflixs.herokuapp.com/users/${Username}`, {
            headers: { Authorization: `Bearer ${token}` }
        })
            .then((response) => {
                console.log(response);
